    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new StyleBundle("~/css")
                ...
                .Include("~/Content/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css")
            ...
            bundles.Add(new ScriptBundle("~/js")
                ...
                .Include("~/Content/jquery-validation/dist/jquery.validate.js")
                .Include("~/Content/jquery-validation-unobtrusive/jquery.validate.unobtrusive.js")
                .Include("~/Content/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js")
